            ...
            <section id="faq" className="faq section-bg">
                <div className="container" data-aos="fade-up">
                    ...
                    <div className="faq-list">
                        <ul>
                        {
                            FAQList.items.map((questions) => {
                                const target = "#faq-list-" + questions.id;
                                const ID = "faq-list-" +  questions.id;
                                return(
                                    <li data-aos="fade-up" data-aos-delay={questions.delay} key={questions.id}>
                                        <i className="bx bx-help-circle icon-help"/>
                                        <a data-bs-toggle="collapse" className="collapsed" data-bs-target={target}>
                                            {questions.question}
                    ...
                    {/* <div className="faq-list">
                        <ul>
                            <li data-aos="fade-up">
                            <i className="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-1" className="collapsed">Non consectetur a erat nam at lectus urna duis? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
